...
**Acceptance Criteria:**
- [ ] GroupActor handles `CreateGroup` message — validates and persists a new group to MongoDB
- [ ] GroupActor handles `UpdateGroup` message — updates name, description, and/or words
- [ ] GroupActor handles `DeleteGroup` message — removes group from MongoDB
- [ ] Validation: group must have a `name` and at least 24 words
